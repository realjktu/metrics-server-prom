...
export KUBECONFIG=/home/prometheus/.kube/config
...
KUBE_REQUEST_TIMEOUT="--request-timeout='5s'"
...
if ! ERROR="$( (kubectl cluster-info ${KUBE_REQUEST_TIMEOUT} 3>&2 2>&1 1>&3) 2>/dev/null) )"; then
	>&2 echo "FAILED"
